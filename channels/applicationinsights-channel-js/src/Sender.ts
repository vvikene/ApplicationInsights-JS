...
export class Sender implements IChannelControlsAI {
     ...
     * error handler
     */
    public _onError(payload: string[], message: string, event?: ProgressEvent) {
        this._logger.throwInternal(
            LoggingSeverity.WARNING,
    ...
    private _xhrSender(payload: string[], isAsync: boolean) {
        ...
        xhr.onerror = (event: ProgressEvent) => this._onError(payload, this._formatErrorMessageXhr(xhr), event);
    ...
    private _xdrSender(payload: string[], isAsync: boolean) {
        ...
        xdr.onerror = (event: ProgressEvent) => this._onError(payload, this._formatErrorMessageXdr(xdr), event);
